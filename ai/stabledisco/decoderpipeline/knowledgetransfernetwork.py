...
class KnowledgeTransferNetwork(torchmodules.BaseModel):
    ...
    def __init__(
        ...
        self._optimizer = torch.optim.NAdam(self._student.parameters(), max_lr, betas=(0.88, 0.995))
    ...
    def _calc_batch_loss(self, x_inputs, y_targets):
        with torch.autocast(device_type="cuda"):
            ...
            return (
                student_loss * self._student_percent
                + self._student._calc_batch_loss(x_inputs, teacher_out) * self._teacher_percent
            )
